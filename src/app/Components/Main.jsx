      ...
      <div className="relative z-10">
          ...
          <div className="flex justify-between items-center">
            <a href="mailto:arthuronyeanusi@gmail.com" className="group">
              <button className="bg-zinc-900 border border-zinc-800 rounded-full px-6 py-2 text-white hover:bg-white hover:text-black transition duration-300 hidden md:block">
                arthuronyeanusi@gmail.com [cite: 5]
              </button>
            ...
            <ul className="flex space-x-6 md:space-x-10 items-center">
              <li>
                <a href="https://www.linkedin.com/in/arthur-onyeanusi-30a102247/" className="hover:text-zinc-400 transition" target="_blank">
                  <span className="hidden md:block">LinkedIn [cite: 8, 9]</span>
              ...
              <li>
                <a href="https://github.com/Edarth002" className="hover:text-zinc-400 transition" target="_blank">
                  <span className="hidden md:block">Github [cite: 6]</span>
        ...
        <section className="max-w-7xl mx-auto px-6 pt-20 pb-10 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 space-y-6 parallax-content">
            <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight">Arthur Onyeanusi [cite: 1]</h1>
            <p className="text-xl font-medium text-zinc-400 italic">Full Stack Developer [cite: 2]</p>
            <ul className="grid grid-cols-2 gap-4 text-sm text-zinc-300 border-l border-zinc-800 pl-4">
              ...
              <li>• Degree: <span className="text-white">BSc Computer Science [cite: 57, 60]</span></li>
              <li>• City: <span className="text-white">Lagos [cite: 26]</span></li>
        ...
        <section className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-10">
          <div className="bg-zinc-900/30 p-8 rounded-[2.5rem] border border-zinc-800 backdrop-blur-sm hover:border-zinc-700 transition">
            <h3 className="text-xl font-bold mb-8 flex items-center gap-3 text-white">
              <span className="p-2 bg-zinc-800 rounded-xl">🛠️</span> Backend Skills [cite: 17, 18, 19, 20]
            </h3>
            <SkillBar label="Node.js & Express" percent="85%" />
            <SkillBar label="MySQL" percent="80%" />
            <SkillBar label="MongoDB" percent="75%" />
            <SkillBar label="JavaScript/TypeScript" percent="90%" />
          </div>

          <div className="bg-zinc-900/30 p-8 rounded-[2.5rem] border border-zinc-800 backdrop-blur-sm hover:border-zinc-700 transition">
            <h3 className="text-xl font-bold mb-8 flex items-center gap-3 text-white">
              <span className="p-2 bg-zinc-800 rounded-xl">🎨</span> Frontend Skills [cite: 13, 14, 16]
            </h3>
            <SkillBar label="React.js & Next.js" percent="90%" />
            <SkillBar label="TailwindCSS" percent="95%" />
        ...
        <section className="max-w-4xl mx-auto px-6 py-20 bg-transparent">
          <h2 className="text-3xl font-bold text-center mb-16 text-white tracking-tight">Experience & Education [cite: 28, 56]</h2>
          <div className="relative border-l border-zinc-800 ml-4 md:ml-0 md:left-1/2">
            ...
            <div className="mb-16 flex flex-col md:flex-row items-center w-full relative">
              ...
              <div className="md:w-1/2 md:pr-12 md:text-right pl-10 md:pl-0">
                <span className="text-xs font-bold text-green-500 uppercase">Dec 2024 - June 2025 [cite: 31]</span>
                <h3 className="text-lg font-bold text-white mt-1">Frontend Developer @ Enoverlab [cite: 29, 30]</h3>
                <p className="text-zinc-500 text-sm mt-2 leading-relaxed">Built responsive web apps using React.js, Next.js, and TailwindCSS[cite: 32].</p>
              </div>
            </div>
            ...
            <div className="mb-16 flex flex-col md:flex-row items-center w-full relative">
              ...
              <div className="md:w-1/2 md:ml-auto md:pl-12 pl-10">
                <span className="text-xs font-bold text-zinc-500 uppercase">Jan 2024 [cite: 38]</span>
                <h3 className="text-lg font-bold text-white mt-1">Web Developer @ Inspirations Computers [cite: 34, 35]</h3>
                <p className="text-zinc-500 text-sm mt-2 leading-relaxed">Independently deployed company website using Next.js SSR[cite: 39, 41].</p>
              </div>
            </div>
            ...
            <div className="mb-16 flex flex-col md:flex-row items-center w-full relative">
              ...
              <div className="md:w-1/2 md:pr-12 md:text-right pl-10 md:pl-0">
                <span className="text-xs font-bold text-blue-500 uppercase">2021 - Present [cite: 58, 59]</span>
                <h3 className="text-lg font-bold text-white mt-1">B.Sc Computer Science [cite: 57]</h3>
                <p className="text-zinc-500 text-sm mt-2 leading-relaxed">University of Nigeria, Nsukka[cite: 60].</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Full-Stack Solutions", desc: "End-to-end apps with React and Node.js[cite: 13, 17].", icon: "💻" },
              { title: "Database Management", desc: "Scalable data with MySQL and MongoDB[cite: 19, 20].", icon: "🗄️" },
              { title: "UI/UX Development", desc: "Pixel-perfect responsive design with Tailwind[cite: 16, 32].", icon: "🎨" },
              { title: "API Development", desc: "Secure RESTful APIs using Express.js[cite: 18].", icon: "⚙️" }
            ].map((service, i) => (
